...
function getRegistros() {
    ...
    /*
    .openCursor():Devuelve un objeto petición y aplica un método de interación sobre los registros.
    ...
    eliminará el total de operaciones de cada registro anterior, ejecutando una nueva iteración.
    */
    ...
    peticionRegistros.onsuccess = (e) => {
        ...
        if(registro) {
            ...
            btnEliminar.classList.add('py-2', 'px-5', 'bg-red-600', 'hover:bg-red-700', 'text-white', 'font-bold', 'uppercase', 'rounded-lg', 'flex', 'items-center', 'gap-2', 'btn-eliminar');
